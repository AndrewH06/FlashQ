...
const Animation = () => {
  ...
  const notes = `FlashQ is the fastest way to study and prepare yourself for exams. It uses AI to generate flashcards or quizzes from your notes. FlashQ saves you from the hassle of retyping your notes into a studyable questions. You focus on the notes, we will do the rest. It's as simple as pasting your notes and clicking a button! You can then study these flashcards or practice quizzes and test yourself on them.`;
